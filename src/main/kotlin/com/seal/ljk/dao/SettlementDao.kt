...
interface SettlementDao {
    ...
    @Insert("insert into settlement(settlement_id, user_no, invest_no, apply_settle_amt, apply_time, settle_principal, investor_profit, seal_profit, status, settle_time, chain_trans_no, partner_id, partnerWalletAddr, investorWalletAddr, sealWalletAddr, create_date, create_user, update_date, update_user, remark)" +
