...
interface ReconciliationDao {
    ...
    @Insert("insert into lc_reconciliation(reconciliation_id, partner_id, user_no, statistics_date, rcv_amt, loan_amt, settle_amt, balance, investor_total_profit, seal_total_profit, " +
            ...
            "#{reconciliation.settleAmt},#{reconciliation.balance},#{reconciliation.investorTotalProfit},#{reconciliation.sealTotalProfit},#{reconciliation.result}, #{reconciliation.remark})")
    fun create(reconciliation: Reconciliation): Int
